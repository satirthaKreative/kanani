...
<body>
    ...
    <form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" name="frmTransaction" id="frmTransaction">
        ...
        <input type="hidden" name="cancel_return" value="{{ route('satirtha.paypal-payment-error-processing') }}">
        <input type="hidden" name="return" value="{{ route('satirtha.paypal-payment-success-processing',['id'=>$id]) }}">
    </form>
    <!-- /paypal integration -->
