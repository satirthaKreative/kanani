            ...
            <div class="col-md-12 m-b-30">
                <div class="d-block d-sm-flex flex-nowrap align-items-center">
                    <div class="page-title mb-2 mb-sm-0">
                        <h1>Available Time Slot Interval</h1>
                    </div>
                    <div class="ml-auto d-flex align-items-center">
                        <nav>
                            <ol class="breadcrumb p-0 m-b-0">
                                ...
                                <li class="breadcrumb-item active text-primary" aria-current="page">Available Time Slot Interval Table</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                            ...
                            <div class="col-lg-12">
                                <span>
                                    @if(count($configQuery) > 0)
                                        @php $configHead = "Update Available Time Slot Interval"; @endphp
                                    @else
                                        @php $configHead = "Add Available Time Slot Interval"; @endphp
                                    @endif
                                    <a class="btn btn-success text-white" onclick="add_available_time_slot_interval_modal_fx()">{{ $configHead }}</a>
                                </span>
                            </div>
                        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        @endforeach
        <form action="{{ route('admin.student-available-interval-slot-add-update') }}" method="POST">
...
<script>
    ...
    function add_available_time_slot_interval_modal_fx(){
